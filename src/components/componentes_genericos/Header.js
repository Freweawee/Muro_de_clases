            ...
            <nav className="navbar navbar-expand-sm">
                ...
                <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" onClick={()=>this.props.cambiarvista(["to_muroAlumno"])} href="#">Muro Alumnos</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" onClick={()=>this.props.cambiarvista(["to_anuncioAlumno"])} href="#">Anunciate!</a>
                        </li>
                        <li className="nav-item">
